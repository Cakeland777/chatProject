	...
	else
	{
		...
		if (chatRoomOld != null && chatRoom != null)
		{
			...
			if (!chatRoomOld.getName().equals(chatRoom.getName()))
			{
				...
				{
					chatRoomOld.addMessage(new Message("system", nickname + " 님이 " + 	chatRoom.getName() + "로 이동하셨습니다", new java.util.Date().getTime()));
				}
				chatRoom.addMessage(new Message("system", nickname + "님이 참여하셨습니다", new java.util.Date().getTime()));

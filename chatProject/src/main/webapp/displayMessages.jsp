...
<tr>
<td>
<h3><b><%=(String)session.getAttribute("nickname")%></b> 님은 현재 <b><%=roonName%></b>에 있습니다</h3>
<%
	...
	<table width="100%" border="1" cellpadding="2" cellspacing="0">
		<tr>
			<td>
			<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="lightblue">
		<tr>
			<td>
	<span class="white"><%=chatRoom.getNoOfChatters()%> 명 참여중</span><br>
	</td>
	</tr>
	</table>
	<%
